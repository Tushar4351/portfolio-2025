  ...
  return (
    ...
    >
      <motion.div
        ...
        className="mx-auto px-4 py-5 bg-black rounded-3xl w-full my-2"
      >
        <div
        ...
        >
          ...
          <div className="hidden lg:flex text-lg font-semibold items-center gap-5">
            <motion.a
              href="/contact"
              whileHover={{ scale: 1.05 }}
              className="shadow-[0_0_0_3px_#000000_inset] px-4 py-[0.4rem] bg-transparent border-2 border-black dark:border-white dark:text-white text-black rounded-lg font-bold transform hover:-translate-y-1 transition duration-400 flex items-center justify-center gap-2"
            >
              Contact Me
              <span>
